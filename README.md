...
![Molecule](https://github.com/nycrecords/ansible-consul/workflows/Molecule/badge.svg?branch=master&event=pull_request)
[![Average time to resolve an issue](http://isitmaintained.com/badge/resolution/nycrecords/ansible-consul.svg)](http://isitmaintained.com/project/nycrecords/ansible-consul "Average time to resolve an issue")
[![Percentage of issues still open](http://isitmaintained.com/badge/open/nycrecords/ansible-consul.svg)](http://isitmaintained.com/project/nycrecords/ansible-consul "Percentage of issues still open")
...
It can also bootstrap a development or evaluation cluster of 3 server agents running in a Vagrant and VirtualBox based environment. See [README_VAGRANT.md](https://github.com/nycrecords/ansible-consul/blob/master/examples/README_VAGRANT.md) and the associated [Vagrantfile](https://github.com/nycrecords/ansible-consul/blob/master/examples/Vagrantfile) for more details.

- [Consul](#consul)
  - [Role Philosophy](#role-philosophy)
  - [Requirements](#requirements)
  - [Caveats](#caveats)
  - [Role Variables](#role-variables)
    - [`consul_version`](#consul_version)
    - [`consul_architecture_map`](#consul_architecture_map)
    - [`consul_architecture`](#consul_architecture)
    - [`consul_os`](#consul_os)
    - [`consul_zip_url`](#consul_zip_url)
    - [`consul_checksum_file_url`](#consul_checksum_file_url)
    ...
    - [`consul_configure_syslogd`](#consul_configure_syslogd)
    - [`consul_log_path`](#consul_log_path)
    - [`consul_log_file`](#consul_log_file)
    - [`consul_log_rotate_bytes`](#consul_log_rotate_bytes)
    - [`consul_log_rotate_duration`](#consul_log_rotate_duration)
    - [`consul_log_rotate_max_files`](#consul_log_rotate_max_files)
    - [`consul_syslog_facility`](#consul_syslog_facility)
    - [`syslog_user`](#syslog_user)
    - [`syslog_group`](#syslog_group)
    - [`consul_run_path`](#consul_run_path)
    - [`consul_user`](#consul_user)
    - [`consul_manage_user`](#consul_manage_user)
    - [`consul_group`](#consul_group)
    - [`consul_manage_group`](#consul_manage_group)
    - [`consul_group_name`](#consul_group_name)
    - [`consul_retry_interval`](#consul_retry_interval)
    - [`consul_retry_interval_wan`](#consul_retry_interval_wan)
    - [`consul_retry_join_skip_hosts`](#consul_retry_join_skip_hosts)
    - [`consul_retry_max`](#consul_retry_max)
    - [`consul_retry_max_wan`](#consul_retry_max_wan)
    - [`consul_join`](#consul_join)
    - [`consul_join_wan`](#consul_join_wan)
    - [`consul_servers`](#consul_servers)
    - [`consul_bootstrap_expect`](#consul_bootstrap_expect)
    - [`consul_bootstrap_expect_value`](#consul_bootstrap_expect_value)
    - [`consul_gather_server_facts`](#consul_gather_server_facts)
    - [`consul_datacenter`](#consul_datacenter)
    - [`consul_domain`](#consul_domain)
    - [`consul_alt_domain`](#consul_alt_domain)
    - [`consul_node_meta`](#consul_node_meta)
    - [`consul_log_level`](#consul_log_level)
    - [`consul_syslog_enable`](#consul_syslog_enable)
    - [`consul_iface`](#consul_iface)
    ...
    - [`consul_translate_wan_address`](#consul_translate_wan_address)
    - [`consul_advertise_addresses`](#consul_advertise_addresses)
    - [`consul_client_address`](#consul_client_address)
    - [`consul_addresses`](#consul_addresses)
    - [`consul_ports`](#consul_ports)
    - [`consul_node_name`](#consul_node_name)
    - [`consul_recursors`](#consul_recursors)
    - [`consul_iptables_enable`](#consul_iptables_enable)
    - [`consul_acl_policy`](#consul_acl_policy)
    - [`consul_acl_enable`](#consul_acl_enable)
    - [`consul_acl_ttl`](#consul_acl_ttl)
    - [`consul_acl_token_persistence`](#consul_acl_token_persistence)
    ...
    - [`consul_acl_agent_master_token`](#consul_acl_agent_master_token)
    - [`consul_acl_default_policy`](#consul_acl_default_policy)
    - [`consul_acl_master_token`](#consul_acl_master_token)
    - [`consul_acl_master_token_display`](#consul_acl_master_token_display)
    - [`consul_acl_replication_enable`](#consul_acl_replication_enable)
    - [`consul_acl_replication_token`](#consul_acl_replication_token)
    - [`consul_tls_enable`](#consul_tls_enable)
    - [`consul_src_def`](#consul_src_def)
    - [`consul_tls_src_files`](#consul_tls_src_files)
    - [`consul_tls_dir`](#consul_tls_dir)
    - [`consul_tls_ca_crt`](#consul_tls_ca_crt)
    - [`consul_tls_server_crt`](#consul_tls_server_crt)
    - [`consul_tls_server_key`](#consul_tls_server_key)
    - [`consul_tls_files_remote_src`](#consul_tls_files_remote_src)
    - [`consul_encrypt_enable`](#consul_encrypt_enable)
    - [`consul_encrypt_verify_incoming`](#consul_encrypt_verify_incoming)
    - [`consul_encrypt_verify_outgoing`](#consul_encrypt_verify_outgoing)
    - [`consul_disable_keyring_file`](#consul_disable_keyring_file)
    - [`consul_raw_key`](#consul_raw_key)
    - [`consul_tls_verify_incoming`](#consul_tls_verify_incoming)
    - [`consul_tls_verify_outgoing`](#consul_tls_verify_outgoing)
    - [`consul_tls_verify_incoming_rpc`](#consul_tls_verify_incoming_rpc)
    - [`consul_tls_verify_incoming_https`](#consul_tls_verify_incoming_https)
    - [`consul_tls_verify_server_hostname`](#consul_tls_verify_server_hostname)
    - [`consul_tls_min_version`](#consul_tls_min_version)
    - [`consul_tls_cipher_suites`](#consul_tls_cipher_suites)
    - [`consul_tls_prefer_server_cipher_suites`](#consul_tls_prefer_server_cipher_suites)
    - [`consul_install_remotely`](#consul_install_remotely)
    - [`consul_install_upgrade`](#consul_install_upgrade)
    - [`consul_ui`](#consul_ui)
    - [`consul_ui_legacy`](#consul_ui_legacy)
    - [`consul_disable_update_check`](#consul_disable_update_check)
    - [`consul_enable_script_checks`](#consul_enable_script_checks)
    - [`consul_enable_local_script_checks`](#consul_enable_local_script_checks)
    - [`consul_raft_protocol`](#consul_raft_protocol)
    - [`consul_node_role`](#consul_node_role)
    - [`consul_autopilot_enable`](#consul_autopilot_enable)
      - [`consul_autopilot_cleanup_dead_servers`](#consul_autopilot_cleanup_dead_servers)
      - [`consul_autopilot_last_contact_threshold`](#consul_autopilot_last_contact_threshold)
      - [`consul_autopilot_max_trailing_logs`](#consul_autopilot_max_trailing_logs)
      - [`consul_autopilot_server_stabilization_time`](#consul_autopilot_server_stabilization_time)
      - [`consul_autopilot_redundancy_zone_tag`](#consul_autopilot_redundancy_zone_tag)
      - [`consul_autopilot_disable_upgrade_migration`](#consul_autopilot_disable_upgrade_migration)
      - [`consul_autopilot_upgrade_version_tag`](#consul_autopilot_upgrade_version_tag)
      - [Custom Configuration Section](#custom-configuration-section)
  - [Consul Snapshot Agent](#consul-snapshot-agent)
    - [`consul_snapshot`](#consul_snapshot)
    - [`consul_snapshot_storage`](#consul_snapshot_storage)
    - [`consul_snapshot_interval`](#consul_snapshot_interval)
    - [`consul_snapshot_retain`](#consul_snapshot_retain)
  - [OS and Distribution Variables](#os-and-distribution-variables)
    - [`consul_centos_pkg`](#consul_centos_pkg)
    - [`consul_centos_url`](#consul_centos_url)
    - [`consul_centos_sha256`](#consul_centos_sha256)
    - [`consul_centos_os_packages`](#consul_centos_os_packages)
    - [`consul_debian_pkg`](#consul_debian_pkg)
    - [`consul_debian_url`](#consul_debian_url)
    - [`consul_debian_sha256`](#consul_debian_sha256)
    - [`consul_debian_os_packages`](#consul_debian_os_packages)
    - [`consul_redhat_pkg`](#consul_redhat_pkg)
    - [`consul_redhat_url`](#consul_redhat_url)
    - [`consul_redhat_sha256`](#consul_redhat_sha256)
    - [`consul_redhat_os_packages`](#consul_redhat_os_packages)
    - [consul_systemd_restart_sec](#consul_systemd_restart_sec)
    - [consul_systemd_limit_nofile](#consul_systemd_limit_nofile)
    - [`consul_ubuntu_pkg`](#consul_ubuntu_pkg)
    - [`consul_ubuntu_url`](#consul_ubuntu_url)
    - [`consul_ubuntu_sha256`](#consul_ubuntu_sha256)
    - [`consul_ubuntu_os_packages`](#consul_ubuntu_os_packages)
    - [`consul_windows_pkg`](#consul_windows_pkg)
    - [`consul_windows_url`](#consul_windows_url)
    - [`consul_windows_sha256`](#consul_windows_sha256)
    - [`consul_windows_os_packages`](#consul_windows_os_packages)
    - [`consul_performance`](#consul_performance)
      - [`raft_multiplier`](#raft_multiplier)
      - [`leave_drain_time`](#leave_drain_time)
      - [`rpc_hold_timeout`](#rpc_hold_timeout)
      - [`leave_on_terminate`](#leave_on_terminate)
  - [Dependencies](#dependencies)
  - [Example Playbook](#example-playbook)
    - [ACL Support](#acl-support)
    - [Dnsmasq DNS Forwarding Support](#dnsmasq-dns-forwarding-support)
    - [`consul_delegate_datacenter_dns`](#consul_delegate_datacenter_dns)
    - [`consul_dnsmasq_enable`](#consul_dnsmasq_enable)
    - [`consul_dnsmasq_bind_interfaces`](#consul_dnsmasq_bind_interfaces)
    - [`consul_dnsmasq_consul_address`](#consul_dnsmasq_consul_address)
    - [`consul_dnsmasq_cache`](#consul_dnsmasq_cache)
    - [`consul_dnsmasq_servers`](#consul_dnsmasq_servers)
    - [`consul_dnsmasq_revservers`](#consul_dnsmasq_revservers)
    - [`consul_dnsmasq_no_poll`](#consul_dnsmasq_no_poll)
    - [`consul_dnsmasq_no_resolv`](#consul_dnsmasq_no_resolv)
    - [`consul_dnsmasq_local_service`](#consul_dnsmasq_local_service)
    - [`consul_dnsmasq_listen_addresses`](#consul_dnsmasq_listen_addresses)
    - [`consul_connect_enabled`](#consul_connect_enabled)
    - [iptables DNS Forwarding Support](#iptables-dns-forwarding-support)
...
See [examples/README_VAGRANT.md](https://github.com/nycrecords/ansible-consul/blob/master/examples/README_VAGRANT.md) for details on quick Vagrant deployments under VirtualBox for development, evaluation, testing, etc.
...
Special thanks to the folks listed in [CONTRIBUTORS.md](https://github.com/nycrecords/ansible-consul/blob/master/CONTRIBUTORS.md) for their contributions to this project.

Contributions are welcome, provided that you can agree to the terms outlined in [CONTRIBUTING.md](https://github.com/nycrecords/ansible-consul/blob/master/CONTRIBUTING.md).
